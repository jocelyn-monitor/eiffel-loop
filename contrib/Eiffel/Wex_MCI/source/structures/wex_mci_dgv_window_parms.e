...
feature -- Status setting
	...
	set_display_window (a_display_window: WEL_COMPOSITE_WINDOW) is
		...
		do
			cwex_mci_dgv_window_set_display_window (item, a_display_window.item)
		end

	set_display_style (a_style: POINTER) is
...
feature {NONE} -- Externals
	...
	cwex_mci_dgv_window_set_display_window (ptr, value: POINTER) is
		external
			"C [macro <dgv_win.h>]"
		end

	cwex_mci_dgv_window_set_display_style (ptr, value: POINTER) is
		external
			"C [macro <dgv_win.h>]"
		end

	cwex_mci_dgv_window_set_caption (ptr, value: POINTER) is
		external
			"C [macro <dgv_win.h>]"
		end
